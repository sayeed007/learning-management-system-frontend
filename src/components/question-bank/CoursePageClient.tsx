// CoursePageClient.tsx - Client Component
'use client'
...
export function CoursePageClient({ courseId }: CoursePageClientProps) {
    ...
    const navigateToQuestions = (sectionId: string) => {
        router.push(`/question-bank/courses/${courseId}/sections/${sectionId}/questions`)
    }

    const navigateToPreview = (sectionId: string) => {
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <Button
                                                variant="outline"
                                                onClick={() => navigateToPreview(section.id)}
